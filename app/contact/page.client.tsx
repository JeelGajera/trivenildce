  ...
  return (
    <>
      <div className="container mx-auto">
        ...
        {/* form container */}
        <form className="relative form__contact min-w-fit z-0 text-lg" onSubmit={handleSubmit(onSubmit)}>
          <fieldset>
            <p>Hey, Stranger!</p>
            <p>
              My name is{" "}
              ...
              />{" "}
              and I&apos;m writing to you since I want to contact you about{" "}
              <Controller
                control={control}
                name="message"
                render={({ field }) => (
            ...
            <button type="submit" className="button button--xlarge text-lg" tabIndex={4}>
              Send message &#187;
            </button>
          </fieldset>
        </form>
