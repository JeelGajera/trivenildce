      ...
      <div className="container flex items-center flex-wrap justify-center md:justify-between lg:justify-between w-[98%]">
        <div className="text w-[100%] md:w-[50%] lg:w-[60%] p-3">
          ...
          <div className="buttons mt-10 w-[100%]">
            <button
              className="p-3 mr-5 inline-flex items-center justify-center opacity-90 hover:opacity-100 w-[20sem] sm:w[5em]"
            ...
            <button
              className="p-3 hover:border-blue-200 opacity-90 hover:opacity-100 w-[5em] lg:w-[7em] mt-5"
